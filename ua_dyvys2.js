...
// ============================
// UA DYVYS OVERRIDE LAYER
// Minimal non-breaking overrides
// ============================
...
(function(){
    ...
    try {
        ...
        window.UA_DYVYS_HOSTS = {
            lumex: 'https://lumex.space',
            uaserials: 'https://uaserials.my',
            uakino: 'https://uakino.me',
            uaflix: 'https://uaflix.net',
            kinobay: 'https://kinobay.org',
            kinotochka: 'https://kinotochka.biz'
        };
        ...
        function filterUkrainianStreams(streams){
        ...
        // ============================
        // PATCH prepareStreams SAFELY
        // ============================

        if (window.prepareStreams){

            var originalPrepareStreams = window.prepareStreams;

            window.prepareStreams = function(streams){

                streams = originalPrepareStreams(streams);

                try {
                    streams = filterUkrainianStreams(streams);
                } catch(e){}
        ...
        if (window.Lampa && Lampa.Listener){
            ...
            Lampa.Listener.follow('full_buttons', function(e){
        ...
        console.log('[UA_DYVYS] Override layer loaded');

    }
    catch(e){

        console.error('[UA_DYVYS] Override error', e);
